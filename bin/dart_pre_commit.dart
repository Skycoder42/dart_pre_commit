  ...
  final parser =
      ArgParser(
        ...
        ..addFlag(
          ...
          abbr: 'c',
          help:
              'Continue checks even if a task rejects a certain file. The '
              'whole hook will still exit with rejected, but only after all '
        ...
        ..addOption(
          ...
          abbr: 'd',
          help:
              'Set the directory to run this command in. By default, it will '
        ...
        ..addOption(
          ...
          abbr: 'n',
          help:
              'Use the specified config for configuring the tool instead of '
        ...
        ..addFlag(
          ...
          abbr: 'e',
          help:
              'Instead of simply 0/1 as exit code for "commit ok" or "commit '
              'needs user intervention", output exit codes according to the '
              'full hook result (See HookResult).',
        )
        ..addOption(
          'log-level',
          abbr: 'l',
          ...
          help:
              'Specify the logging level for task logs. This only affects logs '
              'of tasks, not the status update message. The levels are:',
          valueHelp: 'level',
          allowedHelp: {
        ...
        ..addFlag(
          ...
          help:
              'When enabled, a rich, ANSI-backed output is used. If disabled, '
              'a simple logger is used, which is optimized for logging to '
              'files. The mode is auto-detected, but might not detect all '
              'terminals correctly. In this case, you can use this option to '
              'set it explicitly.',
        )
        ..addSeparator('Other:')
        ..addFlag(
